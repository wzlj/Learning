...
def batch_pred(models_path, images_list, labels_nums, data_format):
    ...
    input_images = tf.placeholder(dtype=tf.float32, shape=[
                                  None, resize_height, resize_width, depths], name='input')

    # model
    with slim.arg_scope(resnet_v1.resnet_arg_scope()):
        out, end_points = resnet_v1.resnet_v1_50(
            inputs=input_images, num_classes=labels_nums, is_training=False)
...
def main(_):
    ...
    if False:
        ...
        models_path = '/home/swshare/model/resnet50_v1/best_models.ckpt'
