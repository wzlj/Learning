...
use_cuda = True
model = tc.load('../data/model_data512_0.1_2019-07-09 14:36:01/model46_111.58943423256278_0.10844454250006101')
...
if __name__ == "__main__":
    ...
    dst_path = "../data/test/predict_{}/".format(time.strftime("%m-%d %H:%M", time.localtime()))
