...
def resnet_model_fn(features, labels, mode, model_class,
  ...
  logits, padded, initial_conv, max_pool = model(features, mode == tf.estimator.ModeKeys.TRAIN)
...
def resnet_main(
  ...
  run_config = tf.estimator.RunConfig(
      ...
      # train_distribute=None,  # added by jlai, test for distribution
  ...
  if flags_obj.export_dir is not None:
    ...
    # classifier.export_saved_model(flags_obj.export_dir, input_receiver_fn) This is for tf2.0
